...
class Server{
    ...
    constructor(){
        ...
        this.roboPath = '/api/robos' //Ruta pública robos
        this.alquilerPath ='/api/alquiler'
        this.middlewares();
        this.conectarDB()
        this.routes()
    }
    ...
    routes(){
        this.app.use(this.roboPath, require('../routes/robos'))
        this.app.use(this.alquilerPath, require('../routes/alquiler'))
    }
